...
#mpl.rcParams['axes.labelcolor'] = u'#555555'
...
mpl.rcParams['ytick.color'] = u'#555555'
mpl.rcParams['xtick.color'] = u'#555555'
...
#mpl.rcParams['font.sans-serif'] = [u'Arial',]
mpl.rcParams['font.sans-serif'] = [u'Bitstream Vera Sans', u'DejaVu Sans', u'Lucida Grande', u'Verdana', u'Geneva', u'Lucid', u'Arial',u'Helvetica', u'Avant Garde', u'sans-serif']
...
def plot_boxplotscatter(X,fig_prefix,xlabel,ylabel,xticks_labels,colors=None,ylim=1,scatter=1,markersize=7):
	fig = plt.figure(dpi=300)
	ax = fig.add_subplot(111)
	bp = ax.boxplot(X)
	for box in bp['boxes']:
